...
![Version: 1.3.0-beta.4](https://img.shields.io/badge/Version-1.3.0-beta.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.3.0-beta.4](https://img.shields.io/badge/AppVersion-v1.3.0-beta.4-informational?style=flat-square)
...
| osm.image.tag | string | `"1.3.0-beta.4"` | Container image tag for control plane images |
