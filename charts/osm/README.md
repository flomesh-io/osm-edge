...
![Version: 1.2.1-ubi8](https://img.shields.io/badge/Version-1.2.1--ubi8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.2.1](https://img.shields.io/badge/AppVersion-v1.2.1-informational?style=flat-square)
...
| osm.curlImage | string | `"quay.io/flomesh/curl-ubi8:7.84.0"` | Curl image for control plane init container |
...
| osm.image.name | object | `{"osmBootstrap":"osm-edge-bootstrap-ubi8","osmCRDs":"osm-edge-crds-ubi8","osmController":"osm-edge-controller-ubi8","osmHealthcheck":"osm-edge-healthcheck-ubi8","osmInjector":"osm-edge-injector-ubi8","osmPreinstall":"osm-edge-preinstall-ubi8","osmSidecarInit":"osm-edge-sidecar-init-ubi8"}` | Image name defaults |
| osm.image.name.osmBootstrap | string | `"osm-edge-bootstrap-ubi8"` | osm-boostrap's image name |
| osm.image.name.osmCRDs | string | `"osm-edge-crds-ubi8"` | osm-crds' image name |
| osm.image.name.osmController | string | `"osm-edge-controller-ubi8"` | osm-controller's image name |
| osm.image.name.osmHealthcheck | string | `"osm-edge-healthcheck-ubi8"` | osm-healthcheck's image name |
| osm.image.name.osmInjector | string | `"osm-edge-injector-ubi8"` | osm-injector's image name |
| osm.image.name.osmPreinstall | string | `"osm-edge-preinstall-ubi8"` | osm-preinstall's image name |
...
| osm.prometheus.image | string | `"quay.io/prometheus/prometheus:v2.34.0"` | Image used for Prometheus |
...
| osm.sidecarDrivers | list | `[{"proxyServerPort":6060,"sidecarImage":"quay.io/flomesh/pipy-ubi8:0.70.0-46","sidecarName":"pipy"},{"proxyServerPort":15128,"sidecarImage":"envoyproxy/envoy:v1.19.3","sidecarName":"envoy","sidecarWindowsImage":"envoyproxy/envoy-windows:latest"}]` | Sidecar drivers supported by osm-edge |
...
| osm.sidecarDrivers[0].sidecarImage | string | `"quay.io/flomesh/pipy-ubi8:0.70.0-46"` | Sidecar image for Linux workloads |
