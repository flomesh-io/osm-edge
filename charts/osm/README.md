...
| osm.pipyRepoImage | string | `"flomesh/pipy-repo:0.70.0-24"` | Pipy repo image for Pipy sidecar's proxy control plane container |
...
| osm.sidecarDrivers | list | `[{"proxyServerPort":6060,"sidecarImage":"flomesh/pipy:0.70.0-24","sidecarName":"pipy"},{"proxyServerPort":15128,"sidecarImage":"envoyproxy/envoy:v1.19.3","sidecarName":"envoy","sidecarWindowsImage":"envoyproxy/envoy-windows:latest"}]` | Sidecar drivers supported by osm-edge |
...
| osm.sidecarDrivers[0].sidecarImage | string | `"flomesh/pipy:0.70.0-24"` | Sidecar image for Linux workloads |
