...
| contour.sidecar | object | `{"image":{"registry":"docker.io","repository":"envoyproxy/envoy-alpine","tag":"v1.19.3"}}` | Contour sidecar edge proxy configuration |
...
| osm.sidecarLogLevel | string | `"error"` | Log level for the Sidecar proxy sidecar. Non developers should generally never set this value. In production environments the LogLevel should be set to `error` |
...
| osm.featureFlags.enableWASMStats | bool | `true` | Enable extra Sidecar statistics generated by a custom WASM extension |
...
| osm.sidecarImage | string | `"envoyproxy/envoy-alpine:v1.19.3@sha256:874e699857e023d9234b10ffc5af39ccfc9011feab89638e56ac4042ecd4b0f3"` | Sidecar sidecar image for Linux workloads |
| osm.sidecarWindowsImage | string | `"envoyproxy/envoy-windows:v1.19.3@sha256:f990f024e7e95f07b6c0d416684734607761e382c35d1ba9414c7e3fbf23969c"` | Sidecar sidecar image for Windows workloads |
