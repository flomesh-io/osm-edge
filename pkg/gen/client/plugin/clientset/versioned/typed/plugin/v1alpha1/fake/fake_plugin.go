...
var pluginsResource = schema.GroupVersionResource{Group: "plugin.flomesh.io", Version: "v1alpha1", Resource: "plugins"}

var pluginsKind = schema.GroupVersionKind{Group: "plugin.flomesh.io", Version: "v1alpha1", Kind: "Plugin"}
