...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SidecarDriverConfigSpec) DeepCopyInto(out *SidecarDriverConfigSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SidecarDriverConfigSpec.
func (in *SidecarDriverConfigSpec) DeepCopy() *SidecarDriverConfigSpec {
	if in == nil {
		return nil
	}
	out := new(SidecarDriverConfigSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SidecarDriverSpec) DeepCopyInto(out *SidecarDriverSpec) {
	*out = *in
	if in.DriverConfigs != nil {
		in, out := &in.DriverConfigs, &out.DriverConfigs
		*out = make([]SidecarDriverConfigSpec, len(*in))
		copy(*out, *in)
	}
	return
}
