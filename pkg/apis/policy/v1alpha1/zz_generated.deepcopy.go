...
func (in *HTTPCircuitBreaking) DeepCopyInto(out *HTTPCircuitBreaking) {
	*out = *in
	in.TCPCircuitBreaking.DeepCopyInto(&out.TCPCircuitBreaking)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TCPCircuitBreaking) DeepCopyInto(out *TCPCircuitBreaking) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TCPCircuitBreaking.
func (in *TCPCircuitBreaking) DeepCopy() *TCPCircuitBreaking {
	if in == nil {
		return nil
	}
	out := new(TCPCircuitBreaking)
	in.DeepCopyInto(out)
	return out
}
