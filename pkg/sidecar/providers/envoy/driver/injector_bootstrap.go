...
func createEnvoyBootstrapFromExisting(ctx *driver.InjectorContext, newBootstrapSecretName, oldBootstrapSecretName, namespace string, cert *certificate.Certificate) (*corev1.Secret, error) {
	...
	return marshalAndSaveBootstrap(ctx, newBootstrapSecretName, namespace, config, cert)
}

func createEnvoyBootstrapConfig(ctx *driver.InjectorContext, name, namespace, osmNamespace string, cert *certificate.Certificate, originalHealthProbes models.HealthProbes) (*corev1.Secret, error) {
...
func marshalAndSaveBootstrap(ctx *driver.InjectorContext, name, namespace string, config *xds_bootstrap.Bootstrap, cert *certificate.Certificate) (*corev1.Secret, error) {
