...
import (
	...
	"github.com/openservicemesh/osm/pkg/sidecar/providers/envoy/secrets"
...
func TestNewResponse(t *testing.T) {
	...
	proxyUUID := uuid.New()
	proxy := envoy.NewProxy(models.KindSidecar, proxyUUID, identity.New(tests.BookbuyerServiceAccountName, tests.Namespace), nil)
...
func TestNewResponseListServicesError(t *testing.T) {
	...
	proxy := envoy.NewProxy(models.KindSidecar, uuid.New(), identity.New(tests.BookbuyerServiceAccountName, tests.Namespace), nil)
...
func TestNewResponseGetEgressTrafficPolicyError(t *testing.T) {
	...
	proxyUUID := uuid.New()
	proxy := envoy.NewProxy(models.KindSidecar, proxyUUID, identity.New("svcacc", "ns"), nil)
