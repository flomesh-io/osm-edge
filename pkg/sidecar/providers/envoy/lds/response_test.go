...
func getProxy(kubeClient kubernetes.Interface) (*envoy.Proxy, *v1.Pod, error) {
	...
	return envoy.NewProxy(models.KindSidecar, uuid.MustParse(tests.ProxyUUID), identity.New(tests.BookbuyerServiceAccountName, tests.Namespace), nil), newPod1, nil
}
